...
from .models import item,orderitem,order,top_product_item,Shipping,Customer,Kitchen_item_category,Special_Offer_item,HouseHold_item_category,Category,Profile,Member_As,Registered_shop
